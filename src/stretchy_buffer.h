...
#define stb_sb_free(a)                                                                                                 \
    ((a) ? free(stb__sbraw(a)), a = NULL, 0 : 0) // FCS Modification: set input 'a' to NULL after
                                                 // free
...
#define stb_sb_deln(a, i, n)                                                                                           \
    (memmove(&(a)[i], &(a)[(i) + (n)], sizeof *(a) * (stb__sbn(a) - (n) - (i))), stb__sbn(a) -= (n))
#define stb_sb_del(a, i) stb_sb_deln(a, i, 1)

#define stb_sb_insn(a, i, n)                                                                                           \
    (stb_sb_add((a), (n)), memmove(&(a)[(i) + (n)], &(a)[i], sizeof *(a) * (stb__sbn(a) - (n) - (i))))
